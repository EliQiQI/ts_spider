...
var cheeliuAnalyzer_1 = __importDefault(require("./cheeliuAnalyzer"));
...
router.get('/getData', function (req, res) {
    ...
    if (isLogin) {
        ...
        new crowller_1.default(url, cheeliuAnalyzer_1.default.getInstance());
        res.send(util_1.getResponseData(true));
    }
    else {
        res.json(util_1.getResponseData(null, '请登录后爬取内容'));
    }
});
